...
type Release struct {
	...
	LockTableName *string `json:"lock_table_name,omitempty"` // DynamoDB table used for grabbing, and releasing locks
...
func (r *Release) Validate(s3c aws.S3API, cRelease interface{}) error {
	...
	if is.EmptyStr(r.LockTableName) {
		return fmt.Errorf("LockTableName must be defined")
	}
